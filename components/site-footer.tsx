...
export function SiteFooter() {
  return (
    <footer id="contact" className="relative border-t border-border/80">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(95,196,255,0.08),transparent_40%)]" />
          ...
          <div className="glass-panel rounded-[2rem] p-8 sm:p-10">
            ...
            <div className="mt-10">
              <a
                ...
                className="group inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 font-mono text-sm tracking-[0.2em] text-primary-foreground uppercase transition-transform duration-200 hover:-translate-y-0.5"
              >
                Get in touch
                <ArrowUpRight
