            ...
            <ScrollReveal key={project.title} as="article" delay={(i % 2) * 100}>
              ...
              >
                ...
                <div className="mt-5 flex items-start justify-between gap-4">
                  ...
                  <span className="mt-1.5 inline-flex shrink-0 items-center gap-1.5 font-mono text-xs tracking-[0.15em] text-muted-foreground uppercase transition-colors group-hover:text-primary">
